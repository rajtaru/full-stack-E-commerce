...
mongoose.connect('mongodb+srv://ommi1:pandu1234@cluster0.q6goc7c.mongodb.net/e-commerce')
...
app.post('/upload',upload.single('product'),(req,res)=>{
   res.json({ success: true, image_url: `https://full-stack-e-commerce-gaf1.onrender.com/images/${req.file.filename}` })
...
//creating endpoint for addto cart
